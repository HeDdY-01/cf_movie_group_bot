...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'cyber_chathan_Update')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.FILE_CAPTION}")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>⬡ Hᴇʟʟᴏ {message.from_user.mention}</b>\n\n⬡ Tɪᴛʟᴇ : <a href={url}>{title}</a></b>\n<b>⬡ Yᴇᴀʀ : {year}</b>\n<b>⬡ Rᴀᴛɪɴɢꜱ : {rating}/ 10</b>\n<b>⬡ Gᴇɴᴇʀꜱ : {genres}</b>\n\n<b>🧩 {message.chat.title} 🧩</b>")
